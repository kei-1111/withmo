...
sealed interface HomeAction : Action {
    ...
    data class OnResizeWidgetBadgeClick(val placedWidget: PlacedWidget) : HomeAction
    data class OnWidgetResizeBottomSheetClose(val placedWidget: PlacedWidget) : HomeAction
